...
@section('content')
  <div class="col-md-6" style="margin-left: auto; margin-right: auto;">
    ...
    <form method="POST" action="/admin/edit_language">

      <input name="id" type="hidden" value="{{ $data->id }}">

      <div class="form-group">
        <label for="exampleFormControlInput1">Language Name</label>
        <input name="name" type="text" class="form-control" value="{{ $data->name }}" placeholder="language name, eg: php" required>
      </div>
      
      <div class="form-group">
        <label for="exampleFormControlInput1">extension</label>
        <input name="extension" type="text" class="form-control" value="{{ $data->extension }}" placeholder="language extension, eg: .php" required>
      </div>
